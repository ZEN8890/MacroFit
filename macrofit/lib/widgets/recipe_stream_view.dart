...
class _RecipeStreamViewState extends State<RecipeStreamView> {
  ...
  String formatDietLabel(String dietValue, bool isEnglishActive) {
    switch (dietValue) {
      case 'All':
        return isEnglishActive ? 'All Diets' : 'Semua Kategori Diet';
      case 'gain_muscle':
        return isEnglishActive ? 'Gain Muscle' : 'Menambah Otot';
      case 'lose_weight':
        return isEnglishActive ? 'Lose Weight' : 'Menurunkan Berat Badan';
      case 'keto_diet':
        return isEnglishActive ? 'Keto Diet' : 'Diet Keto';
      case 'low_carb':
        return isEnglishActive ? 'Low Carbohydrate' : 'Rendah Karbohidrat';
      case 'balanced':
        return isEnglishActive ? 'Balanced Nutrition' : 'Gizi Seimbang';
      case 'Normal':
        return 'Normal';
      default:
        return dietValue
                                  ...
                                  child: Text(
                                    widget.filterType == 'Favorites'
                                        ? (englishActive
                                              ...
                                              : 'Tidak ada resep khusus diet "${formatDietLabel(widget.savedDietFilter, englishActive)}".')
                                        : (englishActive
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  if (displayType != 'AI' &&
                                      (extractedImageUrl == null ||
                                          extractedImageUrl.trim().isEmpty)) {
                                    extractedImageUrl = null;
                                  }
